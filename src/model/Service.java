...
public class Service {
    ...
    public Services ConsultaService(int id) {
    ...
    public void LlenarServicio(JTable table) {

        DefaultTableModel model;
        String[] title = {"Id", "Name"};
        model = new DefaultTableModel(null, title);
        List<Services> data = serviceCtrl.findServicesEntities();
    ...
    public String UpdateService(int id,String name){
        try {
            service.setId(id);
            service.setName(name);
